        ...
        <v-row>
            <v-col lg=6 sm=6 md=6>
                <v-chip label color="blue-grey darken-3" dark>
                    <v-icon left small>mdi-account-badge</v-icon> Salutations
                </v-chip>
            </v-col>
        ...
        <v-row>
            <v-col cols=12>
                <v-card>
                    ...
                    item-key="_id" loading="true" :search="search" dense>
...
import salutation from '../components/salutation/index.vue'
import Config from '../config'
export default {
    components:{salutation,delConfirm},
    mounted(){
        this.fetchrecords();
    },
    data(){
        return{
            // Dlete Url Is here
            delUrl:SERVER_API+'/salutation/delete',
            fab:false,
            header:[
